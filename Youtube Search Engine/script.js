...
function search(){
    ...
    $.get(
        "https://www.googleapis.com/youtube/v3/search",{
            ...
            q:q,
            type:'video',
            key:'AIzaSyCLv6IFzzH0bcre1VjP_MqicNi6W1a6R2U'},
            function(data){
...
function getOutput(item){
    ...
    var output = '<li>'+'<div class="list-left">'+'<img src="'+thumb+'">'+'</div>'+'<div class="list-right">'+'<h3><a class="fancybox fancybox.iframe" href="http://www.youtube.com/embed/'+videoId+'" '+title+'</h3>'+'<small>By<span class="cTitle">'+' '+channelTitle+' '+'</span>on '+videoDate+'</small>'+'<p>'+description+'</p>'+'</div>'+'</li>'+'<div class="clearfix"></div>'+'';
